...
def bollinger_bands(stock, std=2):
    ...
    plt.plot(stock.index, stock.ma_30, color='#ad6eff', label='Moving Average (30 Intervals)')
    plt.plot(stock.index, stock.ma_10, color='#ff6e9d', label='Moving Average (10 Intervals)')
